...
func (x *MapIds) String() string {
	return protoimpl.X.MessageStringOf(x)
}

func (*MapIds) ProtoMessage() {}

func (x *MapIds) ProtoReflect() protoreflect.Message {
	mi := &file_maps_proto_msgTypes[1]
	if protoimpl.UnsafeEnabled && x != nil {
		ms := protoimpl.X.MessageStateOf(protoimpl.Pointer(x))
		if ms.LoadMessageInfo() == nil {
...
// Deprecated: Use MapIds.ProtoReflect.Descriptor instead.
func (*MapIds) Descriptor() ([]byte, []int) {
	return file_maps_proto_rawDescGZIP(), []int{1}
}

func (x *MapIds) GetIds() map[string]*IdWrapper {
	if x != nil {
		return x.Ids
	}
	return nil
...
var file_maps_proto_rawDesc = []byte{
	...
	,
...
var file_maps_proto_goTypes = []interface{}{
	...
	(*MapIds)(nil),    // 1: example.maps.MapIds
	nil,               // 2: example.maps.MapIds.IdsEntry
}
var file_maps_proto_depIdxs = []int32{
	2, // 0: example.maps.MapIds.Ids:type_name -> example.maps.MapIds.IdsEntry
	0, // 1: example.maps.MapIds.IdsEntry.value:type_name -> example.maps.IdWrapper
